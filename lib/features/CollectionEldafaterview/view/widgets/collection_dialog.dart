...
class CollectionModifyOrDeleteDialog extends StatefulWidget {
  ...
  const CollectionModifyOrDeleteDialog({
    super.key,
  ...
  @override
  CollectionModifyOrDeleteDialogState createState() =>
      CollectionModifyOrDeleteDialogState();
}

class CollectionModifyOrDeleteDialogState
    extends State<CollectionModifyOrDeleteDialog> {
